...
const SuccessAlert1 = ({ notify, setNotify }) => {
  setTimeout(() => {
    setNotify(false);
  }, 15000);
  return (
    <div className="">
      ...
      >
        <div className="mr-5 flex  w-full max-w-[34px] items-center justify-center rounded-md bg-green/10">
          <svg
            width="28"
            height="28"
            viewBox="0 0 18 18"
        ...
        <div className="w-full">
          {/* <h5 className="mb-3 text-lg font-semibold text-green-700 dark:text-white">
