...
const About = () => {
  ...
  const skills = [
    {
      ...
      shade: "bg-yellow-500/44",
      shade2: "shadow-yellow-500",
      skillsBranch: ["JavaScript", "Python", "C / C++", "HTML5", 'CSS3', "JSON"]
    },
    {
      skill: "JavaScript Library",
      shade: "bg-blue-500/44",
      shade2: "shadow-blue-500",
      skillsBranch: ["React.js"]
    },
    {
      skill: "Frameworks",
      shade: "bg-pink-500/44",
      shade2: "shadow-pink-500",
      skillsBranch: ["Node.js", "Express.js", "TailwindCSS"]
    },
    {
      skill: "Databases",
      shade: "bg-green-500/44",
      shade2: "shadow-green-500",
      skillsBranch: ["MongoDB", "MySQL"]
    },
    {
      skill: "Tools",
      shade: "bg-purple-500/44",
      shade2: "shadow-purple-500",
      skillsBranch: ["VS Code", "PyCharm", "Linux", "Git & GitHub", 'Canva', "Postman"]
    },
    {
      skill: "Platforms",
      shade: "bg-cyan-500/44",
      shade2: "shadow-cyan-500",
      skillsBranch: ["Google Cloud Platform (GCP)"]
    },
    {
      skill: "Authentication",
      shade: "bg-amber-500/44",
      shade2: "shadow-amber-500",
      skillsBranch: ["Clerk Auth", "JWT Auth"]
    }
  ];
  ...
  return (
    <div className="w-full overflow-hidden mt-20 px-3">

      <div className="w-full h-full flex justify-center items-center">
        <motion.div layout initial={{ opacity: 0, y: 35 }}
      ...
      <motion.div initial={{ opacity: 0.8, scale: 0.9, y: 55 }}
        whileInView={{ opacity: 1, scale: 1, y: 1 }}
        transition={{ duration: .8, visualDuration: .8, type: "easeInOut" }}
        viewport={{ once: true }}
      >
        <div className={`w-full md:h-[39.5vw]  ai-aurora1 shadow-red-500 shadow-[0px_0px_25px_20px] grid md:grid-cols-2 grid-cols-1  mt-15 md:pr-25 rounded-[3.5em]`}>
          <div className="flex items-center justify-center w-full h-full p-5 md:mt-0 mt-3 md:p-10 ">
            <div className={`flex justify-center items-center ${isTab ? "" : ""} aspect-square md:bg-transparent bg-white/44 md:rounded-none rounded-full w-full h-full overflow-hidden md:-translate-y-[3vw] `}>
              <motion.img
                initial={{ opacity: 0.8, y: 350 }}
                whileInView={{ opacity: 1, y: 1 }}
                transition={{ duration: .8, visualDuration: .8, type: "easeInOut" }}
                viewport={{ once: true }}
                src={pranav1.pranav}
                className="w-[78vw] h-[100vw] md:w-[35vw] md:h-[45vw] aspect-square"
              />
            </div>
          </div>
          ...
          <motion.div
            ...
            transition={{ duration: .8, visualDuration: .8, type: "easeInOut" }}
            viewport={{ once: true }}
            className="flex items-center justify-center md:-translate-y-[2.5vw] px-1 py-7 flex-col w-full ">
            <div className="w-full md:text-[4.5vw] text-[8.8vw] md:px-0 px-4 text-center font-extrabold text-white ">“ Turning ideas into Full Stack realities ”</div>
            <motion.div initial={{ y: 30 }} animate={{ y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className={`w-full md:text-[3vw] text-[6vw] text-center font-extrabold text-white md:mt-10 mt-10 `}> I'm Pranav N</motion.div>
            <motion.div initial={{ y: 30 }} animate={{ y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className={`w-full md:text-[3vw] text-[6vw] text-center font-extrabold text-white `} >MERN Stack Developer</motion.div>
          </motion.div>
        </div>
      </motion.div>
      ...
      <div className="w-full px-3 pt-14 pb-3 ">
        <motion.div initial={{ opacity: 0, y: isMobile ? 35 : 350 }} viewport={{ once: true }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, visualDuration: 0.4, bounce: 0 }} className="w-full my-4 pb-20 bg-white/30 backdrop-blur-lg rounded-[2.5em] md:rounded-[4.5em] shadow-2xl shadow-white/44">
          <div className="w-full md:text-6xl text-5xl font-extrabold flex justify-center items-center md:pt-15 pt-15 text-red-500/88">About Me</div>
            ...
            <motion.div initial={{ opacity: 0, y: 283 }} viewport={{ once: true }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, visualDuration: 0.4, bounce: 0 }} onMouseEnter={() => { setColour(index); }} onMouseLeave={() => { setColour(null); }} className={` w-full flex md:flex-row flex-col px-8 backdrop-blur-lg  bg-white/30 rounded-[3.5em] md:rounded-[4.5em] md:py-0 pt-5 pb-10 hover:bg-white duration-300 cursor-default shadow-0 hover:shadow-[0px_0px_35px_20px] ${key.shadow}`}>
              ...
              <div className="flex-1/2 w-full px-4 py-10 /text-shadow-red-500 /text-shadow-2xs flex-col flex justify-center items-center text-xl text-black/55">
                <motion.span initial={{ opacity: 0, x: 30 }} viewport={{ once: true }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.4, visualDuration: 0.4, bounce: 0 }}
                  className={`md:text-3xl text-2xl md:py-5.5 pb-3.5 font-extrabold text-black/55 ${colour === index ? ` ${key.colour}` : ""}`}>
                  {key.name}
                </motion.span>
                ...
                <div className="flex gap-3 md:mt-5 mt-8 md:text-lg md:flex-row flex-col">
