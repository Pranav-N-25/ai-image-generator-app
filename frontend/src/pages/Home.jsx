      ...
      <div className="w-full flex justify-center items-center ">
        <div className="">
          <div className=" relative flex justify-center items-center ">
            <AnimatePresence>
              <div ref={carouselRef} onScroll={onScroll} className=" overflow-y-hidden md:h-160 h-185 snap-container  carousel w-full flex gap-4 overflow-x-scroll scroll-smooth  snap-x snap-mandatory">
