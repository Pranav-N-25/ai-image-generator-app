...
const NotFoundPage = () => {
  return (
    <>
      ...
      <div className={ `
                      ml-8 mx-1.5  text-gray-500 / 55 text-md cursor-default font-bold transition duration-300 hover:bg-gradient-to-r  hover:from-red-400 hover:to-yellow-300 hover:text-white px-6 py-2.5 rounded-4xl
                       `}
>
        {/* // to={`/${value == "Home" ? '' : value.toLocaleLowerCase()}`} */}
        {/* <div >{value}</div> */}
